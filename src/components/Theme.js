...
const Theme = () => {
  return (
    <div className="relative h-full flex flex-col justify-start items-center overflow-hidden box-border">
      <Gradient degree={310} />
      ...
      <div className="w-full h-auto flex flex-col md:flex-row items-center justify-center gap-4 mt-24">
        ...
        <img src={Cyberpunk2} alt="Cyberpunk Theme" className="w-72 h-52" />
      </div>
      <div className="w-full h-auto flex flex-col md:flex-row items-center justify-center gap-4 mt-24">
        <img src={Cyberpunk2} alt="Cyberpunk Theme" className="w-72 h-52" />
        <p className="text-White text-xl pr-5 max-w-lg text-center md:text-left">
